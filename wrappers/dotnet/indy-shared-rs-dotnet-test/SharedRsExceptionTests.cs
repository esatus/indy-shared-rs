...
namespace indy_shared_rs_dotnet_test
{
    public class SharedRsExceptionTests
    {
        private static IEnumerable<TestCaseData> CreateErrorCodeCases()
        {
            ...
            yield return new TestCaseData("message matching to rust errorCode", "some exta from rust errorCode", "1", "Input")
                .SetName("SharedRsExceptions contains ErrorCode 'Input' text after parsing the code to string.");
            yield return new TestCaseData("message matching to rust errorCode", "some exta from rust errorCode", "2", "IOError")
                .SetName("SharedRsExceptions contains ErrorCode 'IOError' text after parsing the code to string.");
            yield return new TestCaseData("message matching to rust errorCode", "some exta from rust errorCode", "3", "InvalidState")
                .SetName("SharedRsExceptions contains ErrorCode 'InvalidState' text after parsing the code to string.");
            yield return new TestCaseData("message matching to rust errorCode", "some exta from rust errorCode", "4", "Unexpected")
                .SetName("SharedRsExceptions contains ErrorCode 'Unexpected' text after parsing the code to string.");
            yield return new TestCaseData("message matching to rust errorCode", "some exta from rust errorCode", "5", "CredentialRevoked")
                .SetName("SharedRsExceptions contains ErrorCode 'CredentialRevoked' text after parsing the code to string.");
            yield return new TestCaseData("message matching to rust errorCode", "some exta from rust errorCode", "6", "InvalidUserRevocId")
                .SetName("SharedRsExceptions contains ErrorCode 'InvalidUserRevocId' text after parsing the code to string.");
            yield return new TestCaseData("message matching to rust errorCode", "some exta from rust errorCode", "7", "ProofRejected")
                .SetName("SharedRsExceptions contains ErrorCode 'ProofRejected' text after parsing the code to string.");
            yield return new TestCaseData("message matching to rust errorCode", "some exta from rust errorCode", "8", "RevocationRegistryFull")
                .SetName("SharedRsExceptions contains ErrorCode 'RevocationRegistryFull' text after parsing the code to string.");
            yield return new TestCaseData("no message", "some exta from rust errorCode", "99", "Unknown error code")
        ...
        public Task SharedRsExceptionsRightMessages(string testMessage, string testExtra, string errorCode, string expected)
        {
            //Arrange
